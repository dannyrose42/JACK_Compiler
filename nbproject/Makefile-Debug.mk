...
${OBJECTDIR}/CompilationEngine.o: CompilationEngine.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CompilationEngine.o CompilationEngine.cpp

${OBJECTDIR}/Tokenizer.o: Tokenizer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Tokenizer.o Tokenizer.cpp
